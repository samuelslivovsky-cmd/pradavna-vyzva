...
export function renderEmail({ eyebrow, title, lines = [], list = [], cta, photo }) {
  ...
  const ctaHtml = cta
    ? `<div style="margin-top:34px;"><a href="${cta.url}" style="display:inline-block;padding:15px 30px;background:${C.gold};color:#1a1426;text-decoration:none;border-radius:999px;font-weight:bold;letter-spacing:1px;font-size:16px;font-family:Georgia,serif;">${cta.label}</a></div>`
    : ''
...
<tr><td style="background:${C.card};border:1px solid ${C.border};border-radius:18px;padding:56px 32px;text-align:center;font-family:Georgia,'Times New Roman',serif;">
